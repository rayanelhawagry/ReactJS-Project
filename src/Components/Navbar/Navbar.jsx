        ...
        <>
            <nav className="navbar navbar-expand-lg position-sticky top-0 start-0 end-0">
                <div className="container pt-3 pb-3 d-flex justify-content-between align-items-center">
                    <div className='title'>
                        <Link className="navbar-brand text-light fs-2 fw-bolder text-uppercase" to={''}>Start Framework</Link>
                    </div>
                    <div className='btn'>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                <li className="nav-item ms-2">
                                    <NavLink className="nav-link fs-6 fw-bolder text-uppercase" to={'about'}>about</NavLink>
                                </li>
                                <li className="nav-item ms-2">
